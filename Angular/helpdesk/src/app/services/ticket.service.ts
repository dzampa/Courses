...
export class TicketService {
  ...
  findByParams(page:number,count:number,assignerToMe:boolean,t:Ticket){
    ...
    return this.http.get(`${HELP_DESK_API}/api/ticket/${page}/${count}/${t.number}/${t.title}/${t.status}/${t.priority}/${assignerToMe}`);
  }
